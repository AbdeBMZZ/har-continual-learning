...
class-balanced reservoir sampling. Each class retains at most
$\lfloor |\mathcal{M}| / |\mathcal{K}| \rfloor$ samples. When a new sample
$(\mathbf{x}, y)$ arrives for class $c$, it replaces an existing buffer
entry with probability:
\begin{equation}
    p_{\mathrm{replace}} =
