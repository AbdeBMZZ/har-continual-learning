...
|   |   |-- online_calibration.py  # temperature + seuil adaptatif
...
d'anticipation LSTM, fall-risk, SSL/foundation-style, calibration+RL, adaptateur
CORAL — est un module Python indépendant intégré dans \texttt{HARContinualModel}.
Les expériences valident l'augmentation de données, l'UWR et CORAL ;
l'anticipation multi-classe atteint $\approx$0,60--0,64 de macro-F1. Le chapitre
suivant présente l'évaluation systématique.
