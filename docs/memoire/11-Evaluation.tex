...
de l'échantillonnage UWR. Un \texttt{DomainAdapter} (ou CORAL bibliographique)
intermédiaire avant chaque nouveau domaine pourrait stabiliser les embeddings.
...
mais encore limitée ; l'adaptation de domaine reste un levier cross-capteur. Les axes
